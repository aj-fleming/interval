...
namespace boost
{
  namespace numeric
  {
    ...
    template <class T, class Policies>
    inline interval<T, Policies>::interval() : low(static_cast<T>(0)), up(static_cast<T>(0))
    {
    }
    ...
    template <class T, class Policies>
    inline interval<T, Policies>::interval(interval<T, Policies> const &r) : low(r.lower()), up(r.upper())
    {
    }
    ...
    template <class T, class Policies>
    inline void interval<T, Policies>::set_empty()
    {
    ...
    template <class T, class Policies>
    inline void interval<T, Policies>::set_whole()
    {
    ...
    template <class T, class Policies>
    inline interval<T, Policies> interval<T, Policies>::hull(const T &x, const T &y)
    {
    ...
    template <class T, class Policies>
    inline interval<T, Policies> interval<T, Policies>::empty()
    {
    ...
    template <class T, class Policies>
    inline interval<T, Policies> interval<T, Policies>::whole()
    {
